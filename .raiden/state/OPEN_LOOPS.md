...
- **LOOP-002 — WSL→macOS migration remediation** — completed 2026-06-07. All `/mnt/e/` path references replaced with `E:\Citadel/` equivalents across AGENTS.md, raiden-orientation.md, fresh-install-handoff.md, and CURRENT_STATE.md. `commit-msg` hook execute bit set. Global scan confirmed clean. Committed `5ce8c45` and pushed.
